...
UNSUBSCRIBE_CONFIRMED = """Ми отримали твій запит на скасування підписки.

Ти можеш скасувати підписку самостійно в боті з курсом (PLACEHOLDER_COURSE_BOT_LINK), але ми також скасуємо її вручну.
